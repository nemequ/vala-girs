/* gcr-ui-3.vapi generated by vapigen-0.22, do not modify. */
...
namespace Gcr {
	...
	public class CertificateRenderer : GLib.Object, Gcr.Certificate, Gcr.ComparableIface, Gcr.Renderer {
	...
	public interface Viewer : Gtk.Widget {
		...
		public static Gcr.Viewer new_scrolled ();
	...
	[CCode (cheader_filename = "ui/gcr-ui.h")]
	public static Gcr.Viewer viewer_new_scrolled ();
}
