/* gxml-0.20.vapi generated by valac 0.45.2.7-c9a6a-dirty, do not modify. */
...
namespace GXml {
	...
	public class DomNodeFilter : GLib.Object {
		public delegate int accept_node (GXml.DomNode node);
	...
	[CCode (cheader_filename = "gxml/gxml.h")]
	public class XDocumentFragment : GXml.XDocument, GXml.DomDocumentFragment {
		public XDocumentFragment (GXml.XDocument d);
	}
	[CCode (cheader_filename = "gxml/gxml.h")]
	public class XDocumentType : GXml.XChildNode, GXml.DomNode, GXml.DomChildNode, GXml.DomDocumentType {
		protected string _name;
		protected string _public_id;
		protected string _system_id;
