/* gxml-0.20.vapi generated by valac 0.48.2.113-c404a, do not modify. */
...
namespace GXml {
	 ...
	 */
	[CCode (cheader_filename = "gxml/gxml.h")]
	public class StreamReader : GLib.Object {
		/**
		 * Creates a new {@link StreamReader} object.
		 */
		public StreamReader (GLib.InputStream istream);
		/**
		 * Creates a new {@link StreamReader} object and
		 * initialize {@link document} with given document
		 */
		public StreamReader.for_document (GLib.InputStream istream, GXml.DomDocument document);
		 ...
		 */
		public GXml.DomDocument read () throws GLib.Error;
		/**
		 * Use a {@link DomDocument} to initialize {@link document}
		 * and parse its contents to
		 */
		public void read_document (GXml.DomDocument doc) throws GLib.Error;
		/**
	...
	[CCode (cheader_filename = "gxml/gxml.h")]
	public errordomain StreamReaderError {
		INVALID_DOCUMENT_ERROR
	}
	/**
