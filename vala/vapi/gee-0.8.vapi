/* gee-0.8.vapi generated by valac 0.39.4.13-cc1eb-dirty, do not modify. */
...
namespace Gee {
	...
	public interface Traversable<G> : GLib.Object {
		 ...
		 */
		[CCode (ordering = 17)]
		public virtual int count_match (owned Gee.Predicate<G> pred);
		/**
		 ...
		 */
		[CCode (ordering = 16)]
		public virtual bool one_match (owned Gee.Predicate<G> pred);
		/**
