/* libgitg-1.0.vapi generated by valac 0.25.3.11-20cb-dirty, do not modify. */
...
namespace Gitg {
	...
	public class Lanes : GLib.Object {
		public Lanes ();
		public GLib.SList<Gitg.Lane> next (Gitg.Commit next, out int nextpos);
		public void reset ();
	...
	public class Stage : GLib.Object {
		...
		public async Ggit.Diff? diff_index (Gitg.StageStatusFile f, Ggit.DiffOptions? defopts = null) throws GLib.Error;
		public async Ggit.Diff? diff_index_all (Gitg.StageStatusFile[] files, Ggit.DiffOptions? defopts = null) throws GLib.Error;
		public async Ggit.Diff? diff_workdir (Gitg.StageStatusFile f, Ggit.DiffOptions? defopts = null) throws GLib.Error;
		public async Ggit.Diff? diff_workdir_all (Gitg.StageStatusFile[] files, Ggit.DiffOptions? defopts = null) throws GLib.Error;
	...
	public class StageStatusEnumerator : GLib.Object {
		public void cancel ();
		public async Gitg.StageStatusFile[] next_files (int num);
	}
	[CCode (cheader_filename = "libgitg/libgitg.h")]
	public class StageStatusFile : GLib.Object {
