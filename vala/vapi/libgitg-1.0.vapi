/* libgitg-1.0.vapi generated by valac 0.29.2.11-731a0-dirty, do not modify. */
...
namespace Gitg {
	...
	public class DiffView : WebKit.WebView {
		...
		public bool default_collapse_all { get; set; }
	...
	public class RepositoryListBox : Gtk.ListBox {
		...
		public Gitg.RepositoryListBox.Row? begin_cloning (string name);
