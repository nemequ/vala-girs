/* valadoc-1.0.vapi generated by valac 0.14.0, do not modify. */
...
namespace Valadoc {
	namespace Api {
		...
		[CCode (cheader_filename = "valadoc-1.0.h")]
		public class Delegate : Valadoc.Api.TypeSymbol {
			...
			public override Valadoc.Api.NodeType node_type { get; }
			public Valadoc.Api.TypeReference? return_type { get; set; }
		}
		[CCode (cheader_filename = "valadoc-1.0.h")]
		public class Enum : Valadoc.Api.TypeSymbol {
			public Enum (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, void* data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public override Valadoc.Api.NodeType node_type { get; }
		...
		public class ErrorDomain : Valadoc.Api.TypeSymbol {
			public ErrorDomain (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, string? dbus_name, void* data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public string? get_dbus_name ();
		...
		public class Interface : Valadoc.Api.TypeSymbol {
			public Interface (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, string? dbus_name, void* data);
			public override void accept (Valadoc.Api.Visitor visitor);
			public void add_interface (Valadoc.Api.TypeReference iface);
			protected override Valadoc.Content.Inline build_signature ();
			public Gee.Collection<Valadoc.Api.TypeReference> get_all_implemented_interface_list ();
			public string? get_cname ();
			public string? get_dbus_name ();
			public Gee.Collection<Valadoc.Api.TypeReference> get_implemented_interface_list ();
		...
		[CCode (cheader_filename = "valadoc-1.0.h")]
		public class Method : Valadoc.Api.Member {
		...
		public abstract class Node : Valadoc.Api.Item, Valadoc.Api.Browsable, Valadoc.Documentation, Gee.Comparable<Valadoc.Api.Node> {
			...
			protected bool do_document { get; private set; }
		...
		[CCode (cheader_filename = "valadoc-1.0.h")]
		public class Signal : Valadoc.Api.Member {
			public Signal (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, string? dbus_name, bool is_dbus_visible, bool is_virtual, void* data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
			public string get_dbus_name ();
		...
		public class Struct : Valadoc.Api.TypeSymbol {
			public Struct (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, string? dup_function_cname, string? free_function_cname, bool is_basic_type, void* data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
		...
		public class Tree {
			...
			public void import_documentation (Valadoc.Importer.DocumentationImporter[] importers, string[] packages, string[] import_directories);
			public void process_comments (Valadoc.DocumentationParser docparser);
			public Valadoc.Api.Node? search_symbol_cstr (string cname);
		...
		public abstract class TypeSymbol : Valadoc.Api.Symbol {
			public TypeSymbol (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, bool is_basic_type, void* data);
	...
	namespace Content {
		...
		public abstract class BlockContent : Valadoc.Content.ContentElement {
			...
			public override void check (Valadoc.Api.Tree api_root, Valadoc.Api.Node container, Valadoc.ErrorReporter reporter, Valadoc.Settings settings);
		...
		public abstract class ContentElement : GLib.Object {
			...
			public abstract void check (Valadoc.Api.Tree api_root, Valadoc.Api.Node container, Valadoc.ErrorReporter reporter, Valadoc.Settings settings);
		...
		public class ListItem : Valadoc.Content.InlineContent {
			...
			public override void accept_children (Valadoc.Content.ContentVisitor visitor);
			public override void check (Valadoc.Api.Tree api_root, Valadoc.Api.Node container, Valadoc.ErrorReporter reporter, Valadoc.Settings settings);
			public Valadoc.Content.List? sub_list { get; set; }
		}
		[CCode (cheader_filename = "valadoc-1.0.h")]
		...
		public class SourceCode : Valadoc.Content.ContentElement, Valadoc.Content.Inline {
			public enum Language {
				...
				VALA,
				C;
				public static Valadoc.Content.SourceCode.Language? from_string (string str);
				public unowned string to_string ();
			}
			public override void accept (Valadoc.Content.ContentVisitor visitor);
			public override void check (Valadoc.Api.Tree api_root, Valadoc.Api.Node container, Valadoc.ErrorReporter reporter, Valadoc.Settings settings);
		...
		public class WikiLink : Valadoc.Content.InlineContent, Valadoc.Content.Inline {
			...
			public Valadoc.WikiPage page { get; private set; }
		}
		[CCode (cheader_filename = "valadoc-1.0.h")]
	...
	namespace Html {
		...
		public abstract class BasicDoclet : Valadoc.Api.Visitor, Valadoc.Doclet {
			...
			protected void write_package_content (Valadoc.Api.Package node, Valadoc.Api.Node? parent, Valadoc.WikiPage? wikipage = null);
		...
		public class LinkHelper : GLib.Object {
			...
			public string? get_package_link (Valadoc.Api.Package package, Valadoc.Settings settings);
	...
	namespace Importer {
		...
		[CCode (cheader_filename = "valadoc-1.0.h")]
		public class ValadoDocumentationScanner : GLib.Object, Valadoc.Scanner {
			public ValadoDocumentationScanner (Valadoc.Settings settings);
	...
	public class CTypeResolver : Valadoc.Api.Visitor {
		...
		public Valadoc.Api.Node? resolve_symbol (string _name);
		public override void visit_class (Valadoc.Api.Class item);
		public override void visit_constant (Valadoc.Api.Constant item);
		public override void visit_delegate (Valadoc.Api.Delegate item);
		public override void visit_enum (Valadoc.Api.Enum item);
	...
	public class DocumentationParser : GLib.Object, Valadoc.ResourceLocator {
		...
		public Valadoc.Content.Page? parse_wikipage (Valadoc.WikiPage page, Valadoc.Api.Package pkg);
	}
	[CCode (cheader_filename = "valadoc-1.0.h")]
	...
	public class MarkupWriter {
		...
		protected weak GLib.FileStream stream;
		public MarkupWriter (GLib.FileStream stream, bool xml_declaration = true);
	...
	public class WikiPage : GLib.Object, Valadoc.Documentation {
		...
		public bool parse (Valadoc.DocumentationParser docparser, Valadoc.Api.Package pkg);
	...
	public class WikiPageTree : GLib.Object {
		...
		public void create_tree (Valadoc.DocumentationParser docparser, Valadoc.Api.Package package, Valadoc.ErrorReporter reporer);
