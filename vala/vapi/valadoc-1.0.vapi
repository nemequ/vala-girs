/* valadoc-1.0.vapi generated by valac 0.17.3.34-1139a-dirty, do not modify. */
...
namespace Valadoc {
	namespace Api {
		...
		public class SourceFile : GLib.Object {
			public SourceFile (Valadoc.Api.Package package, string relative_path, string? relative_c_path);
		...
		public class Struct : Valadoc.Api.TypeSymbol {
			public Struct (Valadoc.Api.Node parent, Valadoc.Api.SourceFile file, string name, Valadoc.Api.SymbolAccessibility accessibility, Valadoc.Api.SourceComment? comment, string? cname, string? type_id, string? dup_function_cname, string? free_function_cname, bool is_basic_type, void* data);
			public override void accept (Valadoc.Api.Visitor visitor);
			protected override Valadoc.Content.Inline build_signature ();
			public string? get_cname ();
	...
	namespace Gtkdoc {
		...
		public class Parser : GLib.Object, Valadoc.ResourceLocator {
			...
			public Valadoc.Content.Comment? parse (Valadoc.Api.Node element, Valadoc.Api.GirSourceComment gir_comment);
		}
		[CCode (cheader_filename = "valadoc-1.0.h")]
