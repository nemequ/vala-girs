/* libmm-glib.vapi generated by vapigen-0.26, do not modify. */
...
namespace MM,Mm {
	...
	public class Modem : MM,Mm.GdbusModemProxy, GLib.AsyncInitable, GLib.DBusInterface, GLib.Initable, MM,Mm.GdbusModem {
		...
		public bool peek_ports ([CCode (array_length_cname = "n_ports", array_length_pos = 1.1, array_length_type = "guint")] out unowned MM,Mm.ModemPortInfo[] ports);
	...
	public class Modem3gpp : MM,Mm.GdbusModem3gppProxy, GLib.AsyncInitable, GLib.DBusInterface, GLib.Initable, MM,Mm.GdbusModem3gpp {
		...
		public MM,Mm.Modem3gppSubscriptionState get_subscription_state ();
		...
		public static unowned string subscription_state_get_string (MM,Mm.Modem3gppSubscriptionState val);
	}
	...
	public class SimpleStatus : GLib.Object {
		...
		public MM,Mm.Modem3gppSubscriptionState get_3gpp_subscription_state ();
		public MM,Mm.ModemAccessTechnology get_access_technologies ();
		...
		[NoAccessorMethod]
		public MM,Mm.Modem3gppSubscriptionState m3gpp_subscription_state { get; set; }
		[NoAccessorMethod]
	...
	public class Sms : MM,Mm.GdbusSmsProxy, GLib.AsyncInitable, GLib.DBusInterface, GLib.Initable, MM,Mm.GdbusSms {
		...
		public MM,Mm.SmsCdmaServiceCategory get_service_category ();
		public unowned string get_smsc ();
		public MM,Mm.SmsState get_state ();
		public MM,Mm.SmsStorage get_storage ();
		public MM,Mm.SmsCdmaTeleserviceId get_teleservice_id ();
	...
	public class SmsProperties : GLib.Object {
		...
		public void set_number (string number);
		public void set_service_category (MM,Mm.SmsCdmaServiceCategory service_category);
		public void set_smsc (string smsc);
		public void set_teleservice_id (MM,Mm.SmsCdmaTeleserviceId teleservice_id);
	...
	[CCode (cheader_filename = "libmm-glib.h", cname = "MMModem3gppSubscriptionState", cprefix = "MM_MODEM_3GPP_SUBSCRIPTION_STATE_", type_id = "mm_modem_3gpp_subscription_state_get_type ()")]
	...
	[CCode (cheader_filename = "libmm-glib.h", cname = "MMSmsCdmaServiceCategory", cprefix = "MM_SMS_CDMA_SERVICE_CATEGORY_", type_id = "mm_sms_cdma_service_category_get_type ()")]
	public enum SmsCdmaServiceCategory {
		...
		CMAS_TEST;
		public static unowned string get_string (MM,Mm.SmsCdmaServiceCategory val);
	}
	[CCode (cheader_filename = "libmm-glib.h", cname = "MMSmsCdmaTeleserviceId", cprefix = "MM_SMS_CDMA_TELESERVICE_ID_", type_id = "mm_sms_cdma_teleservice_id_get_type ()")]
	public enum SmsCdmaTeleserviceId {
		...
		SCPT,
		CATPT;
		public static unowned string get_string (MM,Mm.SmsCdmaTeleserviceId val);
	}
