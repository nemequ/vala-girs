/* libsecret-unstable.vapi generated by vapigen-0.20, do not modify. */

[CCode (cprefix = "Secret", gir_namespace = "SecretUnstable", gir_version = "0", lower_case_cprefix = "secret_")]
namespace Secret {
	...
	public class Prompt : GLib.DBusProxy, GLib.AsyncInitable, GLib.DBusInterface, GLib.Initable {
		[CCode (has_construct_function = false)]
		protected Prompt ();
		public async GLib.Variant perform (ulong window_id, GLib.Cancellable? cancellable) throws GLib.Error;
		public GLib.Variant perform_sync (ulong window_id, GLib.Cancellable? cancellable, GLib.VariantType return_type) throws GLib.Error;
		public GLib.Variant run (ulong window_id, GLib.Cancellable? cancellable, GLib.VariantType return_type) throws GLib.Error;
	}
	...
	public class Service : GLib.DBusProxy, GLib.AsyncInitable, GLib.DBusInterface, GLib.Initable {
		[CCode (cname = "secret_service_new", has_construct_function = false)]
		public async Service (GLib.Type service_gtype, string? service_bus_name, Secret.ServiceFlags flags, GLib.Cancellable? cancellable) throws GLib.Error;
		...
		public async GLib.Variant prompt (Secret.Prompt prompt, GLib.Cancellable? cancellable) throws GLib.Error;
		[NoWrapper]
		public virtual async GLib.Variant prompt_async (Secret.Prompt prompt, GLib.Cancellable? cancellable) throws GLib.Error;
		public async GLib.Variant prompt_at_dbus_path (string prompt_path, GLib.Cancellable? cancellable) throws GLib.Error;
		...
		[CCode (has_construct_function = false)]
		public Service.sync (GLib.Type service_gtype, string? service_bus_name, Secret.ServiceFlags flags, GLib.Cancellable? cancellable = null) throws GLib.Error;
	...
	[CCode (cheader_filename = "libsecret/secret.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "secret_value_get_type ()")]
	[Compact]
	public class Value {
		[CCode (has_construct_function = false)]
