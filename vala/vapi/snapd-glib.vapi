/* snapd-glib.vapi generated by vapigen, do not modify. */
...
namespace Snapd {
	...
	public class Client : GLib.Object {
		...
		[Version (since = "1.50")]
		public async bool remove2_async (Snapd.RemoveFlags flags, string name, [CCode (delegate_target_pos = 3.5)] Snapd.ProgressCallback? progress_callback, GLib.Cancellable? cancellable) throws GLib.Error;
		[Version (since = "1.50")]
		public bool remove2_sync (Snapd.RemoveFlags flags, string name, [CCode (delegate_target_pos = 3.5)] Snapd.ProgressCallback? progress_callback, GLib.Cancellable? cancellable = null) throws GLib.Error;
		...
		[Version (deprecated = true, deprecated_since = "1.50", since = "1.0")]
	...
	[CCode (cheader_filename = "snapd-glib/snapd-glib.h", cprefix = "SNAPD_REMOVE_FLAGS_", type_id = "snapd_remove_flags_get_type ()")]
	[Flags]
	[Version (since = "1.50")]
