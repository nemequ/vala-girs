/* rygel-server-2.6.vapi generated by valac 0.30.0.49-768701-dirty, do not modify. */
...
namespace Rygel {
	...
	public class DLNAAvailableSeekRangeRequest : Rygel.HTTPSeekRequest {
		public static bool requested (Rygel.HTTPGet request);
	...
	public class DTCPCleartextRequest : Rygel.HTTPSeekRequest {
		...
		public DTCPCleartextRequest (Rygel.HTTPGet request) throws Rygel.HTTPSeekRequestError, Rygel.HTTPRequestError;
		public static bool requested (Rygel.HTTPGet request);
		public static bool supported (Rygel.HTTPGet request);
		public int64 end_byte { get; private set; }
		public int64 range_length { get; private set; }
	...
	public class HTTPByteSeekRequest : Rygel.HTTPSeekRequest {
		public HTTPByteSeekRequest (Rygel.HTTPGet request) throws Rygel.HTTPSeekRequestError, Rygel.HTTPRequestError;
		public static bool requested (Rygel.HTTPGet request);
		public static bool supported (Rygel.HTTPGet request);
	...
	public abstract class MediaEngine : GLib.Object {
		public MediaEngine ();
		public abstract Rygel.DataSource? create_data_source_for_resource (Rygel.MediaObject item, Rygel.MediaResource resource) throws GLib.Error;
