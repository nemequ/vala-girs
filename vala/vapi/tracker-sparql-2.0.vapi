...
/* tracker-sparql-intermediate-vala.vapi generated by valac 0.46.1.155-39331e, do not modify. */
...
namespace Tracker {
	namespace Sparql {
		...
		public abstract class Connection : GLib.Object {
			...
			public new static Tracker.Sparql.Connection bus_new (string service_name, GLib.DBusConnection? dbus_connection = null) throws Tracker.Sparql.Error, GLib.IOError, GLib.DBusError, GLib.Error;
