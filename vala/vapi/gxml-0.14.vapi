/* gxml-0.14.vapi generated by valac 0.35.3.7-da1a, do not modify. */
...
namespace GXml {
	...
	public abstract class BaseCollection : GLib.Object {
		 ...
		 * {@inheritDoc}
		 */
		public abstract bool validate_add (int index, GXml.DomElement element) throws GLib.Error;
		/**
		 * {@inheritDoc}
		 */
	...
	public class GomElement : GXml.GomNode, GXml.DomChildNode, GXml.DomNonDocumentTypeChildNode, GXml.DomParentNode, GXml.DomElement, GXml.GomObject {
		 ...
		 */
		public void initialize_with_namespace (GXml.DomDocument doc, string? namespace_uri, string? prefix, string local_name);
	...
	public interface GomProperty : GLib.Object {
		 ...
		 */
		public abstract string validation_rule { get; set construct; }
		/**
