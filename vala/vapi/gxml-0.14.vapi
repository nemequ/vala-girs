/* gxml-0.14.vapi generated by valac 0.36.1.28-b4c6-dirty, do not modify. */
...
namespace GXml {
	...
	public class GomHashThreeMap : GXml.BaseCollection, GXml.GomCollection {
		 ...
		 * A hashtable with all keys as string to node's index refered. Don't modify it manually.
		 */
		protected GLib.HashTable<string,GLib.HashTable<string,GLib.HashTable<string,int>>> _hashtable;
	...
	public class XParser : GLib.Object, GXml.Parser {
		 ...
		 * in XML
		 */
		public GLib.InputStream create_stream (GLib.Cancellable? cancellable = null) throws GLib.Error;
		/**
		...
		public void read_child_nodes_stream (GLib.InputStream istream, GLib.Cancellable? cancellable = null) throws GLib.Error;
