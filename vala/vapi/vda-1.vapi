/* vda-1.vapi generated by valac 0.51.3, do not modify. */
...
namespace Vda {
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ExpressionOperatorBetweenAnd : Vda.ExpressionOperatorBetween, Vda.SqlExpressionOperatorBetweenAnd {
		public ExpressionOperatorBetweenAnd ();
	}
	/**
	 * Implemenation of {@link SqlExpressionOperatorBetweenSymmetric}
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ExpressionOperatorBetweenSymmetric : Vda.ExpressionOperatorBetween, Vda.SqlExpressionOperatorBetweenSymmetric {
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ExpressionOperatorBetweenSymmetricAnd : Vda.ExpressionOperatorBetweenSymmetric, Vda.SqlExpressionOperatorBetweenSymmetricAnd {
		public ExpressionOperatorBetweenSymmetricAnd ();
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ExpressionOperatorIsDistinct : Vda.ExpressionOperatorBinaryterm, Vda.SqlExpressionOperatorIsDistinct {
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ExpressionOperatorIsNotDistinct : Vda.ExpressionOperatorIsDistinct, Vda.SqlExpressionOperatorIsNotDistinct {
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ExpressionOperatorNotBetween : Vda.ExpressionOperatorBetween, Vda.SqlExpressionOperatorNotBetween {
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ExpressionOperatorNotBetweenAnd : Vda.ExpressionOperatorNotBetween, Vda.SqlExpressionOperatorNotBetweenAnd {
		public ExpressionOperatorNotBetweenAnd ();
	}
	/**
	 * Implemenation of {@link SqlExpressionOperatorNotBetweenSymmetric}
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ExpressionOperatorNotBetweenSymmetric : Vda.ExpressionOperatorBetweenSymmetric, Vda.SqlExpressionOperatorNotBetweenSymmetric {
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ExpressionOperatorNotBetweenSymmetricAnd : Vda.ExpressionOperatorNotBetweenSymmetric, Vda.SqlExpressionOperatorNotBetweenSymmetricAnd {
		public ExpressionOperatorNotBetweenSymmetricAnd ();
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ExpressionOperatorNotIlike : Vda.ExpressionOperatorBinaryterm, Vda.SqlExpressionOperatorNotIlike {
		public ExpressionOperatorNotIlike ();
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ExpressionOperatorNotLike : Vda.ExpressionOperatorBinaryterm, Vda.SqlExpressionOperatorNotLike {
		public ExpressionOperatorNotLike ();
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ValueBinary : Vda.Value, Vda.SqlValueBinary {
		public ValueBinary ();
		/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ValueByte : Vda.ValueInteger, Vda.SqlValueByte {
		public ValueByte ();
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ValueJson : Vda.ValueString, Vda.SqlValueJson {
		public ValueJson ();
	}
	/**
	...
	public class ValueMathExp : GLib.Object, Vda.Stringifiable, Vda.SqlValue, Vda.SqlValueMathExp {
		public ValueMathExp ();
		public Vda.SqlParameters parameters { get; set; }
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ValueTimeNtz : Vda.ValueTimestampNtz, Vda.SqlValueTimeNtz {
		public ValueTimeNtz ();
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ValueUnsignedByte : Vda.ValueUnsignedInteger, Vda.SqlValueUnsignedByte {
		public ValueUnsignedByte ();
	}
	/**
	 * An implementation of {@link SqlValueInt2}
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ValueUnsignedInt2 : Vda.ValueUnsignedInteger, Vda.SqlValueUnsignedInt2 {
		public ValueUnsignedInt2 ();
	}
	/**
	 * An implementation of {@link SqlValueInt4}
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ValueUnsignedInt4 : Vda.ValueUnsignedInteger, Vda.SqlValueUnsignedInt4 {
		public ValueUnsignedInt4 ();
	}
	/**
	 * An implementation of {@link SqlValueInt8}
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ValueUnsignedInt8 : Vda.ValueUnsignedInteger, Vda.SqlValueUnsignedInt8 {
		public ValueUnsignedInt8 ();
	}
	/**
	 * An implementation of {@link SqlValueInteger}
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ValueUnsignedInteger : Vda.Value, Vda.SqlValue, Vda.SqlValueUnsignedInteger {
		public ValueUnsignedInteger ();
	}
	/**
	 * An implementation of {@link SqlValueXml}
	 */
	[CCode (cheader_filename = "vda.h")]
	public class ValueXml : Vda.ValueString, Vda.SqlValueXml {
		public ValueXml ();
	}
	/**
	...
	public interface Connection : GLib.Object {
		...
		/**
		 * Quotes a string representation of a give value, as expected by
		 * the connection.
		 */
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface ConnectionBlob : GLib.Object {
		/**
		 ...
		 */
		public abstract Vda.SqlValueBlob create (GLib.InputStream stream);
		/**
		 ...
		 */
		public abstract void @delete (Vda.SqlValueBlob val);
	}
	/**
	 * Represents a database engine connection, with transactions capabilities
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface ConnectionRolebased : GLib.Object {
		/**
		 * Creates a new {@link Role} using given name and parameters
		 */
		public abstract Vda.Role? create_role (string name, Vda.Parameters @params) throws GLib.Error;
		/**
		 * Get a {@link Role} with data about current user or NULL if no
		 * role information exists for the current connection.
		 */
		public abstract Vda.Role? current_role ();
	}
	/**
	 * Represents a database engine connection, with transactions capabilities
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface ConnectionTransactional : GLib.Object {
		/**
	...
	public interface SqlExpression : GLib.Object, GLib.ListModel {
		 ...
		 */
		public virtual void add_math_expression (string str, Vda.Connection cnc, Vda.SqlParameters? @params = null) throws GLib.Error;
		/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlExpressionOperatorBetweenAnd : GLib.Object, Vda.SqlExpressionOperatorBetween {
	}
	/**
	 * An {@link SqlExpressionOperator} for BETWEEN SYMMETRIC auxiliary void operator
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlExpressionOperatorBetweenSymmetric : GLib.Object, Vda.SqlExpressionOperatorBetween {
	}
	/**
	 * An {@link SqlExpressionOperator} for BETWEEN SYMMETRIC / AND operator, in the form x BETWEEN SYMMETRIC y AND z
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlExpressionOperatorBetweenSymmetricAnd : GLib.Object, Vda.SqlExpressionOperatorBetweenSymmetric {
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlExpressionOperatorIsDistinct : GLib.Object, Vda.SqlExpressionOperatorBinaryterm {
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlExpressionOperatorIsNotDistinct : GLib.Object, Vda.SqlExpressionOperatorIsDistinct {
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlExpressionOperatorNotBetween : GLib.Object, Vda.SqlExpressionOperatorBetween {
	}
	/**
	 * An {@link SqlExpressionOperator} for NOT BETWEEN / AND operator, in the form x NOT BETWEEN y AND z
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlExpressionOperatorNotBetweenAnd : GLib.Object, Vda.SqlExpressionOperatorNotBetween {
	}
	/**
	 * An {@link SqlExpressionOperator} for NOT BETWEEN SYMMETRIC auxiliary void operator
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlExpressionOperatorNotBetweenSymmetric : GLib.Object, Vda.SqlExpressionOperatorBetweenSymmetric {
	}
	/**
	 * An {@link SqlExpressionOperator} for NOT BETWEEN SYMMETRIC / AND operator, in the form x NOT BETWEEN SYMMETRIC y AND z
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlExpressionOperatorNotBetweenSymmetricAnd : GLib.Object, Vda.SqlExpressionOperatorNotBetweenSymmetric {
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlExpressionOperatorNotIlike : GLib.Object, Vda.SqlExpressionOperatorBinaryterm {
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlExpressionOperatorNotLike : GLib.Object, Vda.SqlExpressionOperatorBinaryterm {
	}
	/**
	...
	public interface SqlExpressionValue : GLib.Object, Vda.SqlExpression {
		 ...
		 */
		public virtual void set_math_expression_value (string str, Vda.SqlParameters? @params = null) throws GLib.Error;
		/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlValueBlob : GLib.Object, Vda.SqlValueBinary {
		/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlValueBlobOid : GLib.Object, Vda.SqlValueBlob {
		/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlValueByte : GLib.Object, Vda.SqlValue, Vda.SqlValueInteger {
	}
	/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlValueJson : GLib.Object, Vda.SqlValue, Vda.SqlValueString {
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlValueUnsignedByte : GLib.Object, Vda.SqlValue, Vda.SqlValueUnsignedInteger {
	}
	/**
	 * A value representing an Integer of two bytes long
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlValueUnsignedInt2 : GLib.Object, Vda.SqlValue, Vda.SqlValueUnsignedInteger {
	}
	/**
	 * A value representing an Integer of four bytes long
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlValueUnsignedInt4 : GLib.Object, Vda.SqlValue, Vda.SqlValueUnsignedInteger {
	}
	/**
	 * A value representing an Integer of eight bytes long
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlValueUnsignedInt8 : GLib.Object, Vda.SqlValue, Vda.SqlValueUnsignedInteger {
	}
	/**
	 * A value representing an unsiged integer
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlValueUnsignedInteger : GLib.Object, Vda.SqlValue {
	}
	/**
	 * A string value holding XML data.
	 */
	[CCode (cheader_filename = "vda.h")]
	public interface SqlValueXml : GLib.Object, Vda.SqlValue, Vda.SqlValueString {
	 ...
	 * rows and columns, as a {@link GLib.ListModel} of {@link Vda.RowModel} objects.
	 */
	[CCode (cheader_filename = "vda.h")]
	...
	public interface TableModelSequential : GLib.Object, Vda.Result {
		 ...
		 */
		public abstract Vda.RowModel? current ();
		/**
		 * Navigate to the row data relative to the current row,
		 * in forward or backward direction
		 */
		public virtual bool move (Vda.MoveDirection direction, uint relative) throws GLib.Error;
		/**
	 ...
	 */
	[CCode (cheader_filename = "vda.h")]
	public errordomain SqlCommandSelectError {
