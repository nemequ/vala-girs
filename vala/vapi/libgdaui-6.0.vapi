...
namespace Gdaui {
	...
	public class BasicForm : Gtk.Box, Atk.Implementor, Gtk.Buildable, Gtk.Orientable {
		...
		public void update_data_set () throws GLib.Error;
		[NoAccessorMethod]
	...
	public class EntryBin : Gdaui.EntryWrapper, Atk.Implementor, Gdaui.DataEntry, Gtk.Buildable, Gtk.Orientable {
		[CCode (has_construct_function = false, type = "GtkWidget*")]
	...
	public class EntryBoolean : Gdaui.EntryWrapper, Atk.Implementor, Gdaui.DataEntry, Gtk.Buildable, Gtk.Orientable {
		[CCode (has_construct_function = false, type = "GtkWidget*")]
	...
	public class EntryCombo : Gdaui.EntryShell, Atk.Implementor, Gdaui.DataEntry, Gtk.Buildable, Gtk.Orientable {
		[CCode (has_construct_function = false, type = "GtkWidget*")]
	...
	public class EntryCommonTime : Gdaui.EntryWrapper, Atk.Implementor, Gdaui.DataEntry, Gtk.Buildable, Gtk.CellEditable, Gtk.Orientable {
		[CCode (has_construct_function = false)]
	...
	public class EntryDate : Gdaui.EntryCommonTime, Atk.Implementor, Gdaui.DataEntry, Gtk.Buildable, Gtk.CellEditable, Gtk.Orientable {
		[CCode (has_construct_function = false, type = "GtkWidget*")]
		public EntryDate (Gda.DataHandler dh);
	}
	[CCode (cheader_filename = "libgda-ui/libgda-ui.h", type_id = "gdaui_entry_none_get_type ()")]
	public class EntryNone : Gdaui.EntryWrapper, Atk.Implementor, Gdaui.DataEntry, Gtk.Buildable, Gtk.Orientable {
		[CCode (has_construct_function = false, type = "GtkWidget*")]
		public EntryNone (GLib.Type type);
	}
	[CCode (cheader_filename = "libgda-ui/libgda-ui.h", type_id = "gdaui_entry_number_get_type ()")]
	public class EntryNumber : Gdaui.EntryWrapper, Atk.Implementor, Gdaui.DataEntry, Gtk.Buildable, Gtk.CellEditable, Gtk.Orientable {
		[CCode (has_construct_function = false, type = "GtkWidget*")]
	...
	public class EntryShell : Gtk.Box, Atk.Implementor, Gtk.Buildable, Gtk.Orientable {
		...
		[Version (deprecated = true, deprecated_since = "6.0", since = "5.0.3")]
	...
	public class EntryString : Gdaui.EntryWrapper, Atk.Implementor, Gdaui.DataEntry, Gtk.Buildable, Gtk.CellEditable, Gtk.Orientable {
		[CCode (has_construct_function = false, type = "GtkWidget*")]
	...
	public class EntryTime : Gdaui.EntryCommonTime, Atk.Implementor, Gdaui.DataEntry, Gtk.Buildable, Gtk.CellEditable, Gtk.Orientable {
		[CCode (has_construct_function = false, type = "GtkWidget*")]
		public EntryTime (Gda.DataHandler dh);
	}
	[CCode (cheader_filename = "libgda-ui/libgda-ui.h", type_id = "gdaui_entry_timestamp_get_type ()")]
	public class EntryTimestamp : Gdaui.EntryCommonTime, Atk.Implementor, Gdaui.DataEntry, Gtk.Buildable, Gtk.CellEditable, Gtk.Orientable {
		[CCode (has_construct_function = false, type = "GtkWidget*")]
	...
	public class EntryWrapper : Gdaui.EntryShell, Atk.Implementor, Gdaui.DataEntry, Gtk.Buildable, Gtk.Orientable {
		[CCode (has_construct_function = false)]
	...
	public class ServerOperation : Gtk.Box, Atk.Implementor, Gtk.Buildable, Gtk.Orientable {
		...
		public void update_parameters () throws GLib.Error;
		[NoAccessorMethod]
	...
	public class Set : GLib.Object {
		...
		public unowned GLib.SList<Gdaui.SetGroup> get_groups ();
		public unowned GLib.SList<Gdaui.SetSource> get_sources ();
		[NoAccessorMethod]
