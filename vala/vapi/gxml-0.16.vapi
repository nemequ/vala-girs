/* gxml-0.16.vapi generated by valac 0.39.92.6-1873d-dirty, do not modify. */

[CCode (gir_namespace = "GXml", gir_version = "0.16")]
namespace GXml {
	/**
	...
	public abstract class BaseCollection : GLib.Object, Gee.Traversable<GXml.DomElement>, Gee.Iterable<GXml.DomElement>, GXml.GomCollection {
		/**
	...
	[CCode (cheader_filename = "gxml/gxml.h")]
	public class CssSelectorData : GLib.Object {
		public CssSelectorData ();
		public CssSelectorData.with_values (GXml.CssSelectorType t, string data, string val);
		public string data { get; set; }
		public GXml.CssSelectorType selector_type { get; set; }
	...
	public class CssSelectorParser : GLib.Object {
		...
		public Gee.List<GXml.CssSelectorData?> selectors { get; }
	}
	[CCode (cheader_filename = "gxml/gxml.h")]
	 ...
	 */
	[CCode (cheader_filename = "gxml/gxml.h")]
	public class GomArrayList : GXml.BaseCollection, GXml.GomList {
		public GomArrayList ();
	...
	public class GomElement : GXml.GomNode, GXml.DomChildNode, GXml.DomNonDocumentTypeChildNode, GXml.DomParentNode, GXml.DomElement, GXml.GomObject {
		 ...
		 */
		public async void read_from_file_async (GLib.File f, GLib.Cancellable? cancellable = null) throws GLib.Error;
		/**
		 ...
		 */
		public async void read_from_stream_async (GLib.InputStream istream, GLib.Cancellable? cancellable = null) throws GLib.Error;
		/**
	 ...
	 */
	[CCode (cheader_filename = "gxml/gxml.h")]
	public class GomHashMap : GXml.BaseCollection, GXml.GomMap {
		/**
	 ...
	 */
	[CCode (cheader_filename = "gxml/gxml.h")]
	public class GomHashPairedMap : GXml.BaseCollection, GXml.GomPairedMap {
		/**
	 ...
	 */
	[CCode (cheader_filename = "gxml/gxml.h")]
	public class GomHashThreeMap : GXml.BaseCollection, GXml.GomThreeMap {
		/**
		 * Element's attribute name used to refer of container's element as primery key.
		 * You should define it at construction time
		 * our set it as a construction property.
	...
	public class XParser : GLib.Object, GXml.Parser {
		...
		public async void read_child_nodes_stream_async (GLib.InputStream istream, GLib.Cancellable? cancellable = null) throws GLib.Error;
		/**
	 ...
	 */
	[CCode (cheader_filename = "gxml/gxml.h")]
	public interface GomList : GLib.Object, GXml.GomCollection, Gee.Traversable<GXml.DomElement>, Gee.Iterable<GXml.DomElement> {
	}
	/**
	 * {@link Gee.Iterable} and {@link Gee.Traversable} implementation of {@link GomCollection}
	 */
	[CCode (cheader_filename = "gxml/gxml.h")]
	public interface GomMap : GLib.Object, GXml.GomCollection, Gee.Traversable<GXml.DomElement>, Gee.Iterable<GXml.DomElement> {
		/**
	 ...
	 */
	[CCode (cheader_filename = "gxml/gxml.h")]
	public interface GomPairedMap : GLib.Object, GXml.GomCollection, Gee.Traversable<GXml.DomElement>, Gee.Iterable<GXml.DomElement> {
		/**
	 ...
	 */
	[CCode (cheader_filename = "gxml/gxml.h")]
	public interface GomThreeMap : GLib.Object, GXml.GomCollection, Gee.Traversable<GXml.DomElement>, Gee.Iterable<GXml.DomElement> {
		/**
		 * Returns true if @key is used in collection as primery key.
		 */
		public abstract bool has_primary_key (string key);
	...
	public interface Parser : GLib.Object {
		 ...
		 * in XML
		 */
		public abstract GLib.InputStream create_stream (GLib.Cancellable? cancellable = null) throws GLib.Error;
		/**
		 * Creates asyncronically an {@link GLib.InputStream} to write a string representation
		 * in XML
		 */
		public abstract async GLib.InputStream create_stream_async (GLib.Cancellable? cancellable = null) throws GLib.Error;
		/**
		 ...
		 */
		public abstract void read_child_nodes_stream (GLib.InputStream istream, GLib.Cancellable? cancellable = null) throws GLib.Error;
		/**
		 ...
		 */
		public virtual async void read_file_async (GLib.File file, GLib.Cancellable? cancellable) throws GLib.Error;
		/**
		 ...
		 * Read a {@link GXml.DomDocument} from a {@link GLib.InputStream}
		 */
		public abstract async void read_stream_async (GLib.InputStream stream, GLib.Cancellable? cancellable) throws GLib.Error;
		/**
		 ...
		 * Writes a {@link GXml.DomDocument} to a {@link GLib.File}
		 */
		public virtual async void write_file_async (GLib.File file, GLib.Cancellable? cancellable) throws GLib.Error;
		/**
		 * Writes a {@link GXml.DomDocument} to a {@link GLib.OutputStream}
		 */
