/* gxml-0.16.vapi generated by valac 0.39.7.13-dc0d1-dirty, do not modify. */
...
namespace GXml {
	 ...
	 */
	[CCode (cheader_filename = "gxml/gxml.h")]
	public class GomHashThreeMap : GXml.BaseCollection, GXml.GomCollection {
		/**
		 * Element's attribute name used to refer of container's element as primery key.
		 * You should define it at construction time
		 * our set it as a construction property.
		 ...
		 * as third key.
		 */
		public string attribute_third_key { get; set construct; }
	}
	[CCode (cheader_filename = "gxml/gxml.h")]
