/* gxml-0.18.vapi generated by valac 0.44.1.23-f83ec, do not modify. */
...
namespace GXml {
	...
	public class GomElement : GXml.GomNode, GXml.DomChildNode, GXml.DomNonDocumentTypeChildNode, GXml.DomParentNode, GXml.DomElement, GXml.GomObject {
		 ...
		 */
		public class Attributes : Gee.HashMap<string,GXml.GomProperty>, GXml.DomNamedNodeMap {
			/**
			...
			public void add (string name, GXml.GomProperty prop);
		}
		/**
