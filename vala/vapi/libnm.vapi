/* libnm.vapi generated by vapigen-0.52, do not modify. */
...
namespace NM {
	...
	[CCode (cheader_filename = "NetworkManager.h", cprefix = "NM_", type_id = "nm_vpn_connection_state_reason_get_type ()")]
	public enum VpnConnectionStateReason {
		VPN_CONNECTION_STATE_REASON_UNKNOWN,
		VPN_CONNECTION_STATE_REASON_NONE,
		VPN_CONNECTION_STATE_REASON_USER_DISCONNECTED,
		ACTIVE_CONNECTION_STATE_REASON_USER_DISCONNECTED,
		VPN_CONNECTION_STATE_REASON_DEVICE_DISCONNECTED,
		ACTIVE_CONNECTION_STATE_REASON_DEVICE_DISCONNECTED,
		VPN_CONNECTION_STATE_REASON_SERVICE_STOPPED,
		ACTIVE_CONNECTION_STATE_REASON_SERVICE_STOPPED,
		VPN_CONNECTION_STATE_REASON_IP_CONFIG_INVALID,
		ACTIVE_CONNECTION_STATE_REASON_IP_CONFIG_INVALID,
		VPN_CONNECTION_STATE_REASON_CONNECT_TIMEOUT,
		ACTIVE_CONNECTION_STATE_REASON_CONNECT_TIMEOUT,
		VPN_CONNECTION_STATE_REASON_SERVICE_START_TIMEOUT,
		ACTIVE_CONNECTION_STATE_REASON_SERVICE_START_TIMEOUT,
		VPN_CONNECTION_STATE_REASON_SERVICE_START_FAILED,
		ACTIVE_CONNECTION_STATE_REASON_SERVICE_START_FAILED,
		VPN_CONNECTION_STATE_REASON_NO_SECRETS,
		VPN_CONNECTION_STATE_REASON_LOGIN_FAILED,
		VPN_CONNECTION_STATE_REASON_CONNECTION_REMOVED,
		ACTIVE_CONNECTION_STATE_REASON_CONNECTION_REMOVED
	}
