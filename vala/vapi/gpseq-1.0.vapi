/* gpseq-1.0.vapi generated by valac 0.47.91.22-dea6e3, do not modify. */
...
namespace Gpseq {
	...
	namespace Collectors {
		 ...
		 */
		[CCode (cheader_filename = "gpseq.h")]
		public static Gpseq.Collector<Gee.Map<K,V>,GLib.Object,G> to_map<K,V,G> (owned Gpseq.MapFunc<K,G> key_mapper, owned Gpseq.MapFunc<V,G> val_mapper, owned Gpseq.CombineFunc<V> merger, owned Gee.HashDataFunc<K>? key_hash = null, owned Gee.EqualDataFunc<K>? key_equal = null, owned Gee.EqualDataFunc<V>? value_equal = null);
		/**
