/* retro-gtk-0.14.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "Retro", gir_namespace = "Retro", gir_version = "0.14", lower_case_cprefix = "retro_")]
namespace Retro {
	...
	public class MainLoop : GLib.Object {
		...
		public unowned Retro.Core get_core ();
	...
	public interface Controller : GLib.Object {
		...
		public abstract bool set_rumble_state (Retro.RumbleEffect effect, uint16 strength);
	}
