/* mx-2.0.vapi generated by vapigen-0.20, do not modify. */

[CCode (cprefix = "Mx", gir_namespace = "Mx", gir_version = "2.0", lower_case_cprefix = "mx_")]
namespace Mx {
	...
	public class ActorManager : GLib.Object {
		...
		public ulong add_actor (Clutter.Actor container, Clutter.Actor actor);
		...
		public ulong remove_actor (Clutter.Actor container, Clutter.Actor actor);
		public void remove_container (Clutter.Actor container);
	...
	public class Application : GLib.Application, GLib.ActionGroup, GLib.ActionMap {
		...
		public Mx.Window create_window (string window_title);
	...
	public class BorderImage {
		...
		public bool equal (Mx.BorderImage b2);
	...
	public class BoxLayout : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Focusable, Mx.Scrollable, Mx.Stylable {
		...
		public void insert_actor (Clutter.Actor actor, int position);
	...
	public class Button : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Focusable, Mx.Stylable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public Button ();
	...
	public class Dialog : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Focusable, Mx.Stylable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public Dialog ();
	...
	public class Expander : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Stylable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public Expander ();
	...
	public class Frame : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Stylable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public Frame ();
	}
	...
	public class Grid : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Focusable, Mx.Scrollable, Mx.Stylable {
		...
		public Mx.Align get_line_alignment ();
	...
	public class KineticScrollView : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Focusable, Mx.Scrollable, Mx.Stylable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		...
		public void get_input (out unowned Clutter.InputDevice device, out unowned Clutter.EventSequence sequence);
	...
	[CCode (cheader_filename = "mx/mx.h", type_id = "mx_pager_get_type ()")]
	public class Pager : Mx.Stack, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Focusable, Mx.Stylable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public Pager ();
		public unowned Clutter.Actor get_actor_for_page (uint page);
		public uint get_current_page ();
		public unowned Clutter.Actor get_current_page_actor ();
		public bool get_edge_previews ();
		public uint get_n_pages ();
		public void insert_page (Clutter.Actor child, int position);
		public void next ();
		public void previous ();
		public void set_current_page (uint page, bool animate);
		public void set_current_page_by_actor (Clutter.Actor actor, bool animate);
		public void set_edge_previews (bool edge_previews);
		public bool edge_previews { get; set; }
		[NoAccessorMethod]
		public Clutter.Actor page_actor { owned get; set; }
		[NoAccessorMethod]
	...
	public class ScrollBar : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Stylable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public ScrollBar ();
	...
	public class ScrollView : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Stylable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public ScrollView ();
		public void ensure_visible (Clutter.Geometry geometry);
		public bool get_enable_mouse_scrolling ();
		public Mx.ScrollPolicy get_scroll_policy ();
		public Mx.ScrollPolicy get_scroll_visibility ();
		public void set_enable_mouse_scrolling (bool enabled);
		public void set_scroll_policy (Mx.ScrollPolicy policy);
		public void set_scroll_visibility (Mx.ScrollPolicy visibility);
		public bool enable_mouse_scrolling { get; set; }
		public Mx.ScrollPolicy scroll_policy { get; set; }
		public Mx.ScrollPolicy scroll_visibility { get; set; }
	}
	...
	public class Settings : GLib.Object {
		...
		[NoAccessorMethod]
		public bool touch_mode { get; set; }
	}
	...
	public class Slider : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Focusable, Mx.Stylable {
		...
		public signal void slide_start ();
		public signal void slide_stop ();
	}
	...
	public class Style : GLib.Object {
		...
		public bool load_from_data (string id, string data) throws GLib.Error;
		public bool load_from_file (string filename) throws GLib.Error;
		public bool load_from_resource (string path) throws GLib.Error;
		public virtual signal void changed ();
	}
	...
	public class Table : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Focusable, Mx.Stylable {
		...
		public unowned Clutter.Actor get_actor_at (int row, int column);
		public int get_column_count ();
		public int get_column_spacing ();
		public int get_row_count ();
		public int get_row_spacing ();
		public void insert_actor (Clutter.Actor actor, int row, int column);
	...
	[CCode (cheader_filename = "mx/mx.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "mx_text_shadow_get_type ()")]
	[Compact]
	...
	public class TextureFrame : Clutter.Actor, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable {
		...
		public static void paint_background (Cogl.Handle texture, uint8 opacity, float x, float y, float width, float height);
		public static void paint_texture (Cogl.Handle texture, uint8 opacity, float top, float right, float bottom, float left, float width, float height);
	...
	public class Toggle : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Focusable, Mx.Stylable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public Toggle ();
		public bool get_active ();
		public void set_active (bool active);
	...
	public class Toolbar : Mx.Widget, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Focusable, Mx.Stylable {
		[CCode (has_construct_function = false, type = "ClutterActor*")]
		public Toolbar ();
	...
	public abstract class Widget : Clutter.Actor, Atk.Implementor, Clutter.Animatable, Clutter.Container, Clutter.Scriptable, Mx.Stylable {
		[CCode (has_construct_function = false)]
		protected Widget ();
		public void apply_style (Mx.Style style);
	...
	public interface Stylable : GLib.Object {
		...
		public void disconnect_change_notifiers ();
	...
	[CCode (cheader_filename = "mx/mx.h", cprefix = "MX_DISPLAY_STYLE_", type_id = "mx_display_style_get_type ()")]
	...
	[CCode (cheader_filename = "mx/mx.h", cprefix = "MX_STYLE_ERROR_", type_id = "mx_style_error_get_type ()")]
	public enum StyleError {
		INVALID_FILE,
		PARSE_ERROR
	}
	[CCode (cheader_filename = "mx/mx.h", cprefix = "MX_TEXT_ALIGN_", type_id = "mx_text_align_get_type ()")]
	...
	[CCode (cheader_filename = "mx/mx.h", cprefix = "MX_VISIBILITY_STYLE_", type_id = "mx_visibility_style_get_type ()")]
	...
	[CCode (cheader_filename = "mx/mx.h", cname = "MX_PARAM_STYLE_INHERIT")]
