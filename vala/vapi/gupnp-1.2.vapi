/* gupnp-1.2.vapi generated by vapigen, do not modify. */

[CCode (cprefix = "GUPnP", gir_namespace = "GUPnP", gir_version = "1.2", lower_case_cprefix = "gupnp_")]
namespace GUPnP {
	...
	public abstract class DeviceInfo : GLib.Object {
		...
		[NoAccessorMethod]
		public Soup.URI url_base { owned get; set construct; }
	}
	...
	public class RootDevice : GUPnP.Device, GLib.Initable {
		[CCode (has_construct_function = false)]
		public RootDevice (GUPnP.Context context, string description_path, string description_dir) throws GLib.Error;
		[CCode (has_construct_function = false)]
	...
	public class ServiceProxy : GUPnP.ServiceInfo {
		...
		public bool end_action_list (GUPnP.ServiceProxyAction action, GLib.List<string> out_names, GLib.List<GLib.Type?> out_types, out GLib.List<GLib.Value*> out_values) throws GLib.Error;
		...
		public bool send_action_list (string action, GLib.List<string> in_names, GLib.List<weak GLib.Value?> in_values, GLib.List<string> out_names, GLib.List<GLib.Type?> out_types, out GLib.List<GLib.Value*> out_values) throws GLib.Error;
