/* gck-1.vapi generated by vapigen-0.22, do not modify. */

[CCode (cprefix = "Gck", gir_namespace = "Gck", gir_version = "1", lower_case_cprefix = "gck_")]
namespace Gck {
	[CCode (cheader_filename = "gck.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "gck_attribute_get_type ()")]
	[Compact]
	public class Attribute {
		public global::ulong length;
	...
	[CCode (cheader_filename = "gck.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "gck_attributes_get_type ()")]
	[Compact]
	public class Attributes {
		...
		public bool find_boolean (ulong attr_type, bool value);
		public bool find_date (ulong attr_type, GLib.Date value);
		public bool find_string (ulong attr_type, string value);
		public bool find_ulong (ulong attr_type, ulong value);
		public Gck.Attributes @ref ();
		public Gck.Attributes ref_sink ();
		public string to_string ();
		public static void unref (void* attrs);
	}
	[CCode (cheader_filename = "gck.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "gck_builder_get_type ()")]
	[Compact]
	...
	[CCode (cheader_filename = "gck.h", type_id = "gck_enumerator_get_type ()")]
	public class Enumerator : GLib.Object {
		...
		public void set_object_type (GLib.Type object_type);
		public Gck.Enumerator chained { owned get; set; }
		public GLib.TlsInteraction interaction { owned get; set; }
		public GLib.Type object_type { get; set; }
	}
	[CCode (cheader_filename = "gck.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "gck_mechanism_info_get_type ()")]
	[Compact]
	...
	[CCode (cheader_filename = "gck.h", type_id = "gck_module_get_type ()")]
	...
	[CCode (cheader_filename = "gck.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "gck_module_info_get_type ()")]
	[Compact]
	public class ModuleInfo {
		public ulong flags;
		public weak string library_description;
		public uint8 library_version_major;
		public uint8 library_version_minor;
		public weak string manufacturer_id;
		public uint8 pkcs11_version_major;
		public uint8 pkcs11_version_minor;
		public Gck.ModuleInfo copy ();
		public void free ();
	}
	[CCode (cheader_filename = "gck.h", type_id = "gck_object_get_type ()")]
	...
	[CCode (cheader_filename = "gck.h", type_id = "gck_password_get_type ()")]
	...
	[CCode (cheader_filename = "gck.h", type_id = "gck_session_get_type ()")]
	...
	[CCode (cheader_filename = "gck.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "gck_session_info_get_type ()")]
	[Compact]
	...
	[CCode (cheader_filename = "gck.h", type_id = "gck_slot_get_type ()")]
	...
	[CCode (cheader_filename = "gck.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "gck_slot_info_get_type ()")]
	[Compact]
	public class SlotInfo {
		...
		public weak string manufacturer_id;
		public weak string slot_description;
		public Gck.SlotInfo copy ();
		public void free ();
	}
	[CCode (cheader_filename = "gck.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "gck_token_info_get_type ()")]
	[Compact]
	public class TokenInfo {
		...
		public weak string serial_number;
	...
	[CCode (cheader_filename = "gck.h", copy_function = "g_boxed_copy", free_function = "g_boxed_free", type_id = "gck_uri_data_get_type ()")]
	[Compact]
	public class UriData {
		public bool any_unrecognized;
		public weak Gck.Attributes attributes;
		public weak Gck.ModuleInfo module_info;
		public weak Gck.TokenInfo token_info;
		[CCode (has_construct_function = false)]
		public UriData ();
		public Gck.UriData copy ();
		public void free ();
	}
	[CCode (cheader_filename = "gck.h", type_id = "gck_object_cache_get_type ()")]
	...
	[CCode (cheader_filename = "gck.h", has_type_id = false)]
	public struct Mechanism {
		public ulong type;
		public void* parameter;
		public ulong n_parameter;
	}
	[CCode (cheader_filename = "gck.h", cprefix = "GCK_BUILDER_", type_id = "gck_builder_flags_get_type ()")]
	public enum BuilderFlags {
		NONE,
		SECURE_MEMORY
	}
	[CCode (cheader_filename = "gck.h", cprefix = "GCK_ERROR_MODULE_", type_id = "gck_error_get_type ()")]
	public enum Error {
		PROBLEM;
		public static GLib.Quark get_quark ();
	}
	[CCode (cheader_filename = "gck.h", cprefix = "GCK_SESSION_", type_id = "gck_session_options_get_type ()")]
	[Flags]
	...
	[CCode (cheader_filename = "gck.h", cprefix = "GCK_URI_", type_id = "gck_uri_error_get_type ()")]
	...
	[CCode (cheader_filename = "gck.h", cprefix = "GCK_URI_", type_id = "gck_uri_flags_get_type ()")]
	[Flags]
	...
	[CCode (cheader_filename = "gck.h", cname = "GCK_URI_FOR_MODULE_WITH_VERSION")]
	public const int URI_FOR_MODULE_WITH_VERSION;
	[CCode (cheader_filename = "gck.h", cname = "GCK_URI_FOR_OBJECT_ON_TOKEN")]
	public const int URI_FOR_OBJECT_ON_TOKEN;
	[CCode (cheader_filename = "gck.h", cname = "GCK_URI_FOR_OBJECT_ON_TOKEN_AND_MODULE")]
	public const int URI_FOR_OBJECT_ON_TOKEN_AND_MODULE;
	[CCode (cheader_filename = "gck.h", cname = "GCK_VENDOR_CODE")]
	public const int VENDOR_CODE;
	[CCode (cheader_filename = "gck.h")]
