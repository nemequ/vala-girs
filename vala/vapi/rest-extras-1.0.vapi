...
[CCode (cprefix = "RestExtras", gir_namespace = "RestExtras", gir_version = "1.0", lower_case_cprefix = "rest_extras_")]
namespace RestExtras {
	[CCode (cheader_filename = "RestExtras-1.0.h", cname = "FlickrProxy", type_id = "flickr_proxy_get_type ()")]
	public class FlickrProxy : Rest.Proxy {
		...
		public RestExtras.FlickrProxyCall new_upload ();
		[CCode (cname = "flickr_proxy_new_upload_for_file")]
		public RestExtras.FlickrProxyCall new_upload_for_file (string filename) throws GLib.Error;
	...
	[CCode (cheader_filename = "RestExtras-1.0.h", cname = "FlickrProxyCall", type_id = "flickr_proxy_call_get_type ()")]
	...
	[CCode (cheader_filename = "RestExtras-1.0.h", cname = "LastfmProxy", type_id = "lastfm_proxy_get_type ()")]
	...
	[CCode (cheader_filename = "RestExtras-1.0.h", cname = "LastfmProxyCall", type_id = "lastfm_proxy_call_get_type ()")]
	public class LastfmProxyCall : Rest.ProxyCall {
		[CCode (has_construct_function = false)]
		protected LastfmProxyCall ();
	}
	[CCode (cheader_filename = "RestExtras-1.0.h", cname = "YoutubeProxy", type_id = "youtube_proxy_get_type ()")]
	public class YoutubeProxy : Rest.Proxy {
		...
		public bool upload_async (string filename, GLib.HashTable<void*,void*> fields, bool incomplete, [CCode (delegate_target_pos = 5.1, scope = "async")] RestExtras.YoutubeProxyUploadCallback callback, GLib.Object weak_object) throws GLib.Error;
	...
	[CCode (cheader_filename = "RestExtras-1.0.h", instance_pos = 6.9)]
	public delegate void YoutubeProxyUploadCallback (RestExtras.YoutubeProxy proxy, string payload, size_t total, size_t uploaded, GLib.Error error, GLib.Object weak_object);
}
